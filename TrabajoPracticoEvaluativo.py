...
while True:
    ...
    nombre=input("ingrese el nombre de los estudiantes, o que deseea realizar ")
    if nombre.lower()=="salir":
        break
    nombre_estudiantes.append(nombre)
    if nombre.lower()=="repetir":
         print("Nombres ingresados hasta el momento:", nombre_estudiantes)
         continue
    
    validacion=len(nombre)
    tipo_validacion=nombre.isalpha()
    if tipo_validacion==True:
     continue
    else:
