...
conjunto=list(zip(marcas,productos))
for marca,producto in conjunto:
...
traducciones_unidas=list(zip(numeros_espaniol,numeros_portugues,numeros_ingles))
for español,prortugues,ingles in traducciones_unidas:
    print(español,prortugues,ingles)
# #-----------------------------------------------------------------------------------------
...
print("Trabajo realzado por Adrian Ramirez")