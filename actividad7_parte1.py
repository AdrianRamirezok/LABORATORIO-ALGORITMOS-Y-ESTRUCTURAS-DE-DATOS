...
class cubo():
    ...
    def __init__(self,color):
        self.color=color
cubo_rojo=cubo("rojo")
print(f"mi cubo es {cubo_rojo.color} y tiene {cubo_rojo.caras} caras")
...
class Personaje:
    ...
    def lanzar_flecha(self):
            ...
            self.cantidad_flechas > 0
            self.cantidad_flechas -= 1
            print(f"Flecha lanzada flechas restantes: {self.cantidad_flechas}")
      

personaje = Personaje(cantidad_flechas=5)
personaje.lanzar_flecha()  
personaje.lanzar_flecha()  
personaje.lanzar_flecha()  
print(f"Flechas restantes después de lanzar: {personaje.cantidad_flechas}")
...
alumno = Alumno(nombre="Juan", edad=20, matricula="12345")
...
class Perro(Mascota):
    def __init__(self, nombre, edad, cantidad_patas, raza):
        super().__init__(nombre, edad, cantidad_patas)
        self.raza = raza

mi_perro = Perro(nombre="Firulais", edad=3, cantidad_patas=4, raza="Labrador")
...
class Automovil(Vehiculo):
    def __init__(self, marca, modelo):
        self.marca = marca
        self.modelo = modelo
mi_automovil = Automovil(marca="Toyota", modelo="Corolla")
...
libro = Libro("One Piece", "Eiichiro Oda", 1000)
print(libro)
